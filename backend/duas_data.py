...
DUA_CATEGORIES: List[Dict] = [
    {
        ...
        "duas": [
            ...
            },
            {
                ...
                "reference": "Qur'an 21:87 — the supplication of Yunus ﷺ",
        ...
        "duas": [
            {
                ...
                "reference": "Al-Bukhari — Sayyid al-Istighfar",
        ...
        "duas": [
            {
                ...
                "reference": "Abu Dawud & At-Tirmidhi — upon leaving home",
            ...
            },
            {
                ...
                "reference": "Abu Dawud — upon entering home",
            },
            {
                "id": "travel_mount",
                ...
                "reference": "Muslim (Qur'an 43:13-14) — when setting out",
            },
        ],
    },
    {
        ...
        "duas": [
            {
                ...
                "reference": "Abu Dawud & At-Tirmidhi — before eating",
            },
            {
                "id": "food_after",
                ...
                "reference": "Abu Dawud & At-Tirmidhi — after eating",
        ...
        "duas": [
            {
                ...
                "reference": "Muslim — nothing will harm him until he moves on",
                "count": 3,
            },
            {
        ...
        "duas": [
            {
                ...
                "reference": "Al-Bukhari — upon waking",
            },
            {
                "id": "daily_sleep",
                ...
                "reference": "Al-Bukhari — before sleeping",
            },
            {
                "id": "daily_garment",
                ...
                "reference": "Abu Dawud & At-Tirmidhi — when dressing",
            },
            {
                "id": "daily_restroom",
                ...
                "reference": "Al-Bukhari & Muslim — before entering the restroom",
            },
        ],
    },
    {
        ...
        "duas": [
            ...
            },
            {
                ...
                "reference": "Muslim — when entering the masjid",
            },
            {
                ...
                "reference": "Muslim — when leaving the masjid",
            },
        ],
    },
]
